...
const Ticket = ({ issue, issueDataset, setIssueDataset }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-wrap sm:flex-nowrap justify-between items-top gap-4 mb-3">
      ...
      <div className="flex flex-wrap sm:flex-nowrap justify-between items-center gap-4">
        <div className="flex flex-wrap sm:flex-nowrap justify-start items-center gap-2">
